...
$success_alert = '<div class="col-12">
	...
	<a href="admin_edit_class.php" class="btn btn-primary">Go Back</a>
</div>';
...
if (isset($_SESSION['status']) && $_SESSION['status'] == 1) { // logged IN
    if (isset($_SESSION['role']) && $_SESSION['role'] == 1) { // admin
        ...
        if ($_SERVER['REQUEST_METHOD'] == "GET") {  // GET request
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                            ...
                            <br>
                            <?php
                            $query = "SELECT * FROM class where id =$tId";
            ...
            if (isset($_POST['t_name']) && isset($_POST['t_summery']) && isset($_POST['t_id'])) {
                $t_id = $_POST['t_id'];
                $t_name = $_POST['t_name'];
                $t_summery = $_POST['t_summery'];

                $update_query = "UPDATE class SET name = '$t_name', summery = '$t_summery' WHERE id = $t_id";
