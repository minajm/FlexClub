...
(4, ''Box Fit'', ''BoxFit is a cardio workout based on the training used for boxing focusing on toning and fitness. It includes skipping, boxing drills and bodyweight exercises that incorporate footwork and abdominal movements.'', ''./image/upload/1590751355madison-lavern-4gcqRf3-f2I-unsplash.jpg'', '''', ''class''),
